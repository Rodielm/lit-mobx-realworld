...
class MainView extends Component {
  ...
  connectedCallback() {
    ...
    this.stores.articlesStore.setPredicate(this.getPredicate())
    this.stores.articlesStore.loadArticles()
  }
  ...
  handleSetPage = page => {
    this.stores.articlesStore.setPage(page)
    this.stores.articlesStore.loadArticles()
  }

  render() {
    const { currentUser } = this.stores.userStore
    const { articles, isLoading, page, totalPagesCount } =
