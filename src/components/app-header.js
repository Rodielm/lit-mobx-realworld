        ...
        return html`
            <ul class="nav navbar-nav pull-xs-right">
                ...
                <li class="nav-item">
                    ...
                    class="nav-link">
                        <img src=${ifDefined(props.currentUser.image || undefined)}
                        class="user-pic" alt=""/>
...
class AppHeader extends Component {
    ...
    render() {
        // const { commonStore: commonStore, userStore: userStore } = this.context.stores || {}
        const { commonStore: commonStore, userStore: userStore } = this.stores || {}
        return html`
